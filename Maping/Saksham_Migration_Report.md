...
| | Tax1, Tax2, Tax3 | `mstparty.vtax1/2/3` (139 / 54 / 3) | Contact view > Remark | `contact.pan`, `gst_no`, `cst` + `contact.remark` | Stored in the tax columns. Also written into Remarks because the tax fields are not shown on the Saksham contact screen |
...
- Tax1, Tax2, Tax3 and Reminder Message are visible to the user in the contact's **Remark**.
